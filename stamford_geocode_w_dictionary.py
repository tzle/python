...
# Input     : csv file key field and address field
# Output    : csv output file containing 2 appended columns: Lat, Lon
...
with open(theInFile, 'rb') as csvFile:  # all lines read-in
    ...
    writeOutList = [] # create output list
    # take headers from input file

    theHeader = ['Call_Number','Address','lat','lon']
